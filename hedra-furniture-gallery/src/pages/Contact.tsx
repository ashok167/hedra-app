            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1">
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold  text-[#14294C]  mb-6">Get in Touch</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold  text-[#14294C]  mb-1">Business Hours</h3>
              ...
              <div className="lg:col-span-2">
                <Card className="shadow-card">
                  <CardHeader>
                    <CardTitle className="text-2xl  text-[#14294C] ">Send us a Message</CardTitle>
                  </CardHeader>
                  <CardContent>
