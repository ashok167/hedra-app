...
console.log("API Response:", response);
        ...
        <section className="bg-muted/30 py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                Explore our portfolio of completed office furniture projects.
              </motion.p>
            </motion.div>
          </div>
        </section>
  ...
  onClick={() =>
    navigate(`/office-project-details/${project.id}`)
  }
>
  <img
  src={`${FILE_BASE_URL}${
